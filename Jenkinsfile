pipeline {
    ...
    stages {   
        ...
        stage('push to nexus') {
            steps {
               nexusArtifactUploader artifacts: [[artifactId: 'WebApplication', classifier: '', file: 'WebApplication/target/WebApplication.war', type: '.war']], credentialsId: 'tom_pass', groupId: 'WebApplication', nexusUrl: 'ec2-3-133-119-77.us-east-2.compute.amazonaws.com:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'maven-snapshots', version: '1.0-SNAPSHOT'
            }   
